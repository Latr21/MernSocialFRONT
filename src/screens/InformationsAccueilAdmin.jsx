...
export default function InformationsAccueilAdmin() {
  ...
  return (
    <main>
      <h1>Gestion des informations d’accueil</h1>

      <button onClick={charger}>Rafraîchir</button>

      <div style={{ display: "grid", gap: 12, marginTop: 12 }}>
        {infos.map((info) => (
          <div key={info._id} style={{ border: "1px solid #ddd", padding: 12, borderRadius: 8 }}>
            {info.image_url && (
              <img
